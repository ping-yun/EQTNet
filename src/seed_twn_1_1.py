...
class ElasticQuantBinarizerUnsigned(torch.autograd.Function):
    ...
    #@staticmethod
    def backward(ctx, grad_output):
        print("ElasticQuantBinarizerUnsigned::backward")
        input_,alpha = ctx.saved_tensors
        grad_scale, Qn, Qp = ctx.other
        q_w = input_/alpha
        indicate_small = (q_w < Qn).float()
...
batch_number_train,dataloader_train = loadTrainData('C://Users//shaonv//Desktop//SEED_3//')
batch_number_test,dataloader_test = loadTestData('C://Users//shaonv//Desktop//SEED_3//')
accuracy_train_list = []
accuracy_test_list = []
    ...
    if((epoch+1)%50==0):
        if best_accuracy_test < (epoch_accuracy_test/batch_number_test):
            ...
            torch.save({ 'epoch':epoch,
                        ...
                        },'C://Users//shaonv//Desktop//SEED_3//model_bwn_1_2.pt')
            print("------------------------------model saved-------------------------------------")
